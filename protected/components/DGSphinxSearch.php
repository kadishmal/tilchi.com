...
class DGSphinxSearch extends CApplicationComponent
{
	 ...
	 * @return $this chain
	 */
	public function filters($filters, $exclude = false)
	{
	 ...
	 * @return $this chain
	 */
	public function limit($offset=null, $limit=null, $max=0)
	{
		...
		if (isset($offset) && isset($limit) && isset($max)) {
			$this->client->setLimits($offset, $limit, $max);
		}
		return $this;
	}
