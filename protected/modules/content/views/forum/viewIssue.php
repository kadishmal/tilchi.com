        ...
        <div class="forum-body">
            <div class="frame">
                <div class="title"><div class="links"><?php
                    echo CHtml::link(Yii::t('ContentModule.forum', 'Forums'), '/forum') . ' / ' .
                         CHtml::link(Yii::t('ContentModule.forum', 'Issues'), '/forum/issues');
                ?></div>
                </div>
                <div class="body">
                    ...
                    <div class="vote-panel">
                        <?php
                            echo CHtml::tag('span', array('class'=>'vote-amount'), Yii::t('ContentModule.forum', '<b>{1} user</b> would like this fixed|<b>{n} users</b> would like this fixed', $model->votesCount));
            ...
            <div class="frame status">
                <div class="title"><h3><?php
                    echo Yii::t('ContentModule.forum', 'The issue status') .
                ...
                <div class="body">
                    <?php
                        ...
                        {
                            echo CHtml::link(Yii::t('ContentModule.forum', 'n==1#New|n==2||n==3#New', Post::TYPE_ISSUE), '/forum/setStatusNew/' . $model->id, array('class'=>'new' . ($model->response_type == Post::RESPONSE_NEW ? ' active' : ''))) .
                                ...
                                CHtml::link(Yii::t('ContentModule.forum', 'n==1#Accepted|n==2||n==3#Accepted', Post::TYPE_ISSUE), '/forum/setStatusAccepted/' . $model->id, array('class'=>'accepted' . ($model->response_type == Post::RESPONSE_ACCEPTED ? ' active' : ''))) .
                                ...
                                CHtml::link(Yii::t('ContentModule.forum', 'n==1#Answered|n==2#Completed|n==3#Fixed', Post::TYPE_ISSUE), '/forum/setStatusCompleted/' . $model->id, array('class'=>'completed' . ($model->response_type == Post::RESPONSE_COMPLETED ? ' active' : ''))) .
