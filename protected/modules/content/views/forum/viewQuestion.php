            ...
            <div class="frame">
                <div class="title"><div class="links"><?php
                    echo CHtml::link(Yii::t('ContentModule.forum', 'Forums'), '/forum') . ' / ' .
                         ...
                         CHtml::link(Yii::t('ContentModule.forum', 'Questions'), '/forum/questions');
                ?></div>
                </div>
                <div class="body">
                    ...
                    <div class="vote-panel">
                        <?php
                            echo CHtml::tag('span', array('class'=>'vote-amount'), Yii::t('ContentModule.forum', '<b>{1} user</b> would like this answered|<b>{n} users</b> would like this answered', $model->votesCount));
                    ...
                    <?php
                        if (Yii::app()->user->name == Yii::app()->params['adminEmail'])
                        {
                            echo CHtml::link(Yii::t('ContentModule.forum', 'n==1#New|n==2||n==3#New', Post::TYPE_QUESTION), '/forum/setStatusNew/' . $model->id, array('class'=>'new' . ($model->response_type == Post::RESPONSE_NEW ? ' active' : ''))) .
                                ...
                                CHtml::link(Yii::t('ContentModule.forum', 'n==1#Accepted|n==2||n==3#Accepted', Post::TYPE_QUESTION), '/forum/setStatusAccepted/' . $model->id, array('class'=>'accepted' . ($model->response_type == Post::RESPONSE_ACCEPTED ? ' active' : ''))) .
                                ...
                                CHtml::link(Yii::t('ContentModule.forum', 'n==1#Answered|n==2#Completed|n==3#Fixed', Post::TYPE_QUESTION), '/forum/setStatusCompleted/' . $model->id, array('class'=>'completed' . ($model->response_type == Post::RESPONSE_COMPLETED ? ' active' : ''))) .
